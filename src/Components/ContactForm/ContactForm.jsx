  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <label htmlFor="nombre" className="label-none">
          Nombre
        </label>
        <input
          type="text"
      ...
      <div className="form-group">
        <span className={apellido.trim() ? "has-content" : ""}></span>
        <label htmlFor="apellido" className="label-none">
          Apellido (Opcional)
        </label>
        <input
          type="text"
      ...
      <div className="form-group">
        <span className={telefono.trim().length > 8 ? "has-content" : ""}>
          <svg
            ...
            fill="currentColor"
          >
            <title>Numero de tel</title>
            <path d="m19.23 15.26-2.54-.29a2 2 0 0 0-1.64.57l-1.84 1.84a15.05 15.05 0 0 1-6.59-6.59l1.85-1.85a2 2 0 0 0 .57-1.64l-.29-2.52a2 2 0 0 0-1.99-1.77H5.03c-1.13 0-2.07.94-2 2.07a17 17 0 0 0 15.89 15.89 1.98 1.98 0 0 0 2.07-2v-1.73a1.98 1.98 0 0 0-1.76-1.98z"></path>
          </svg>
        </span>
        <label htmlFor="telefono" className="label-none">
          Número de Teléfono
        </label>
        <input
          type="tel"
