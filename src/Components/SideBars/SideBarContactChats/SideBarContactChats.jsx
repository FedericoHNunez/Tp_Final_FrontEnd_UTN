...
export const SideBarContactChats = () => {
  ...
  const { messageValue, handleInputChange, handleSubmit, handleKeyDown } =
    useChatForm();
    ...
    <>
      <aside className="asideView">
        <header className="section-header border-bottom">
          <div
            className="contactInfoHeader-left-container center"
              ...
              <div className="contactInfoHeader-left center">
                <div>
                  <img
                    ...
                    src={contact_selected.picture.thumbnail}
                    alt={contact_selected.alias}
                  />
                </div>
          ...
          <div className="contactInfoHeader-right center">
            <button className="center display-none">
              <svg
                ...
                fill="currentColor"
              >
                <title>Iniciar video llamada</title>
                <path
                  fill="currentColor"
          ...
          <div className="contact-messages">
            {contact_selected.messages.map((message) => (
              <div
                key={message.id}
                className={
                  message.sender === "me" ? "message-me" : "message-contact"
                }
              >
                <div
                  className={
