      ...
      <aside className="asideView center backgroundSiderBar">
        <header className="section-header">
          <Link to={`/chats/${contact_selected.id}`}>
            <div className="contact-header-actions center ">
        ...
        <div className="sideBarContactInfo-container">
          <section className="sideBarContactInfo-contact">
            <div className="ContactInfo-img">
              {contact_selected.picture ? (
                <img
                  src={contact_selected.picture.large}
          ...
          <section className="sideBarContactInfo-options">
            <ul>
              <li className="sideBarContactInfo-options-item">
                <Link
                  to={`/chats/${contact_selected.id}`}
                  className="sideBarContactInfo-options-link"
                >
                  <div className="sideBarContactInfo-icon-container center">
                    <svg
                      ...
                      fill="none"
                    >
                      <title>Iniciar nuevo chat</title>
                      <path
                        fill="currentColor"
              ...
              <li className="sideBarContactInfo-options-item">
                <Link
                  to={`/chats/call/${contact_selected.id}`}
                  className="sideBarContactInfo-options-link"
                >
                  <div className="sideBarContactInfo-icon-container center">
                    <svg
              ...
              <li className="sideBarContactInfo-options-item">
                <Link
                  to={`/chats/video-call/${contact_selected.id}`}
                  className="sideBarContactInfo-options-link"
                >
                  <div className="sideBarContactInfo-icon-container center">
                    <svg
                      ...
                      fill="currentColor"
                    >
                      <title>Iniciar Videollamada</title>
                      <path
                        fill="currentColor"
