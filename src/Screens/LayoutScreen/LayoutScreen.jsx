...
export function LayoutScreen() {
  ...
  const hideNavOnMobile =
    contact_id || location.pathname === "/chats/new-contact";

  return (
    <>
      <header
        className={`layout-header ${hideNavOnMobile ? "hide-nav-mobile" : ""}`}
      >
        <MainNavigation />
      </header>
      <main
        className={`layout-main ${hideNavOnMobile ? "has-active-contact" : ""}`}
      >
        <Outlet />
      </main>
    </>
